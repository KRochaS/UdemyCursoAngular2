...
export class GiphySearchComponent implements OnInit {
  ...
  mensagem: string =
    "Aguarde o curso de IONIC, em breve, fique ligado no YouTube ";
  ...
  constructor(
    ...
    protected giphySearchService: GiphySearchService
  ) {}
  ...
  public pesquisarGiphy() {
    this.giphySearchService
      .pesquisarGiphy(this.limit, this.term)
